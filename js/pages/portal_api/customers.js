...
// - /portal/customers/duplicate-candidates
...
export async function portalCustomerDuplicateCandidates_(idToken, payload) {
  return portalCall_("/portal/customers/duplicate-candidates", clonePayload_(payload), idToken);
}
