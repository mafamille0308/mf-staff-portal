...
export async function portalSettingsListIntegrationConfigs_(idToken, payload) {
  return portalCall_("/portal/integrations/config/list", clonePayload_(payload), idToken);
}

export async function portalSettingsUpsertIntegrationConfig_(idToken, payload) {
  return portalCall_("/portal/integrations/config/upsert", clonePayload_(payload), idToken);
}
