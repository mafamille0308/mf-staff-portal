...
// - /portal/billing/price-rules/reorder
...
// - /portal/billing/batches/resync-visit-statuses
...
export async function portalBillingPriceRulesReorder_(idToken, payload) {
  return portalCall_("/portal/billing/price-rules/reorder", clonePayload_(payload), idToken);
}
...
export async function portalBillingBatchResyncVisitStatuses_(idToken, batchId) {
  return portalCall_("/portal/billing/batches/resync-visit-statuses", { batch_id: toTrimmed_(batchId) }, idToken);
}
