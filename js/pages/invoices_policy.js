import {
  ...
  portalBillingBatchResyncVisitStatuses_,
  portalBillingBatchRefundFollowup_,
...
export async function resyncBillingBatchVisitStatusesPolicy_(idToken, batchId) {
  return portalBillingBatchResyncVisitStatuses_(idToken, batchId);
}

export async function setBillingBatchRefundFollowupPolicy_(idToken, payload) {
  return portalBillingBatchRefundFollowup_(idToken, payload);
}
