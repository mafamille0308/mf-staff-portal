import {
  ...
  portalBillingPriceRulesReorder_,
...
export async function reorderBillingPriceRulesForSettings_(idToken, payload) {
  return portalBillingPriceRulesReorder_(idToken, payload);
}
