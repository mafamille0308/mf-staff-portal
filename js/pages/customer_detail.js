      ...
      <form data-el="customerEditForm">
        <div class="card" style="margin-top:12px;">
          ...
          <div class="p">
            ...
            ${customerFeeFieldHtml_(CUSTOMER_FEE_FIELDS_[0], _customerFeeOptions.parking, 0, false, findCustomerFeeSettingForField_(c, CUSTOMER_FEE_FIELDS_[0]))}
            ${customerFeeFieldHtml_(CUSTOMER_FEE_FIELDS_[1], _customerFeeOptions.business_trip, 0, false, findCustomerFeeSettingForField_(c, CUSTOMER_FEE_FIELDS_[1]))}
            ${customerFeeFieldHtml_(CUSTOMER_FEE_FIELDS_[2], _customerFeeOptions.travel, 0, false, findCustomerFeeSettingForField_(c, CUSTOMER_FEE_FIELDS_[2]))}
            ${customerFeeFieldHtml_(CUSTOMER_FEE_FIELDS_[3], _customerFeeOptions.key_pickup, 0, false, findCustomerFeeSettingForField_(c, CUSTOMER_FEE_FIELDS_[3]))}
            ${customerFeeFieldHtml_(CUSTOMER_FEE_FIELDS_[4], _customerFeeOptions.key_return, 0, false, findCustomerFeeSettingForField_(c, CUSTOMER_FEE_FIELDS_[4]))}
            <div class="p" style="margin-bottom:10px;">
