import {
  ...
  portalSettingsListIntegrationConfigs_,
  portalSettingsUpsertIntegrationConfig_,
} from "./portal_api.js";
...
export async function listIntegrationConfigsForSettings_(idToken, payload) {
  return portalSettingsListIntegrationConfigs_(idToken, payload);
}

export async function upsertIntegrationConfigForSettings_(idToken, payload) {
  return portalSettingsUpsertIntegrationConfig_(idToken, payload);
}
